...
function setup(){
    ...
    nave = createSprite(550,200,20,20);
...
function pontos(){
    if(frameCount%80===0){
      ponto1=createSprite(0,Math.round(random(10,390)),20,20);   
...
/*function aliens(){
  if(frameCount%80===0){
    virus05=createSprite(0,600,20,20);   

       virus05.velocityX=2 //(7+(score/4));
     
    virus05.scale=0.2;
    var r=Math.round(random(1,4));
    console.log(r)
    if (r == 1) {
      virus05.addImage(virus05_Img);
    } else if (r == 2) {
      virus05.addImage(virus2_Img);
    } else if (r == 3) {
      virus05.addImage(virus3_Img);
    } else if (r == 3) {
      virus05.addImage(virus4_Img);
    } else {
      virus05.addImage(virus5_Img);
    }
